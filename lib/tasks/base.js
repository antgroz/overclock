import { LifecycleError, TimeoutError } from '../util/errors.js';
...
export class Base extends Emitter {
  ...
  constructor(options) {
    ...
    this._lifecycle.on('*', (event, ...args) => this.emit(event, ...args));
  }
