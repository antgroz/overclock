...
import { LifecycleError, TimeoutError } from './errors.js';
import { kTock } from './symbols.js';
...
export class Base extends EventEmitter {
  ...
  constructor(options) {
    ...
    this._concurrencyLimit = concurrencyLimit ?? -1;
    this._livenessThreshold = livenessThreshold ?? -1;
    this._factoryCapacity = factoryCapacity ?? -1;
    this._generationLimit = generationLimit ?? -1;
    this._startTimeoutMillis = startTimeoutMillis ?? 0;
    this._runTimeoutMillis = runTimeoutMillis ?? -1;
    this._stopTimeoutMillis = stopTimeoutMillis ?? 0;
    this._gracefulTimeoutMillis = gracefulTimeoutMillis ?? -1;
